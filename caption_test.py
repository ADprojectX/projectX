...
def generate_captions(video_file, audio_file):
    ...
    text = "The Placebo Effect occurs when a person experiences an improvement in their symptoms, even though they've received a treatment with no active ingredients. This demonstrates the power of our minds and how our beliefs can influence our physical health."
