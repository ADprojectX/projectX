...
async def download_image(url, filename):
    ...
    if response.status_code == 200:
        ...
        prompt = re.sub(r"_\w{8}-\w{4}-\w{4}-\w{4}-\w{12}", "", prompt.lower()[7:]).strip()
        ...
        if "UPSCALED_" not in filename:
            ...
            top_left.save(os.path.join(output_folder, "option1_" + file_prefix + ".jpg"))
            top_right.save(os.path.join(output_folder, "option2_" + file_prefix + ".jpg"))
            bottom_left.save(os.path.join(output_folder, "option3_" + file_prefix + ".jpg"))
            bottom_right.save(os.path.join(output_folder, "option4_" + file_prefix + ".jpg"))
